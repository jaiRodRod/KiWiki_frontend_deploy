...
import {handleSendEmail} from '../Emails/SendEmail.jsx'
...
function CreateWiki(){
    ...
    async function formHandler(event){
        ...
        if(modify){
            ...
            handleSendEmail(formData.creador, 'Se ha creado correctamente la wiki.', 'Se ha creado correctamente la Wiki ' + formData.nombre + '.')
